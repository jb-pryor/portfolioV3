  ...
  return (
    ...
    {isOpen && (
      <div className='popup' id='popup'>
        ...
        <div className='icons'>
          <a href="https://github.com/jb-pryor" target="_blank" rel="noopener noreferrer"><i className='fab fa-github'></i></a>
          <a href='https://www.linkedin.com/in/james-pryor-571b3a2ab/' target='_blank' rel="noopener noreferrer"><i className='fab fa-linkedin'></i></a>
